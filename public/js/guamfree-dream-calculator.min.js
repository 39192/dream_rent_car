const compactChargeSet = {basic: 55, zdc: 10}, // 컴팩트 5인
...
function processAboutAllChargesOf(e) {
  let t = getReservationCharge(), a = getBasicCharge(e),
    r = a + getZDCCharge(e);
...
function getAdditionalTimeCharge(e) {
  ...
  return t > 0 && t < 6 ? t / .5 * 5 : t >= 6 && t < 7 ? e - (6 == t ? 10 : 5)
    : 0
}
