const compactChargeSet = {basic: 30, zdc: 5}, // 컴팩트 5인
  midSize2ChargeSet = {basic: 65, zdc: 10}, // 미드사이즈
  fullSizeChargeSet = {basic: 75, zdc: 15}, // 풀사이즈 5인
  suvChargeSet = {basic: 80, zdc: 15}, //Ssuv 5인
  convertibleChargeSet = {basic: 120, zdc: 20}, //컨버터블
  sevenVanChargeSet = {basic: 120, zdc: 20}, // 7,8인승 밴
  eightVanChargeSet = {basic: 120, zdc: 20}, chargeSet = {
...
function getReservationCharge() {
  return 5 * getRentDays() // 대여 일수에 대해 10달러를 곱한 값이 예약 요금으로 계산됩니다.
}
...
function getAdditionalTimeCharge(e) {
  ...
  return t > 0 && t < 6 ? t / .5 * 3 : // 추가 시간이 0시간 초과이고 6시간 미만인 경우, 30분마다 5달러의 요금이 부과됩니다.
